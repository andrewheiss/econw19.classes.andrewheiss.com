...
Instead of use calculus to find the area under Lorenz curve, we used this formula where $x$ = income, $y$ = cumulative proportion of the population, and $\mu_x$ = mean of income:
...
This is pretty exciting, since the experiment worked perfectly!^[{-} This game comes from experiment 9 by Dirk Yandell, *Using Economic Experiments in the Classroom* (Upper Saddle River, New Jersey: Prentice Hall, 1999). The book is sadly out of print and doesn't exist anywhere, but [an abstract of the game is listed as Game #66 here](https://w3.marietta.edu/~delemeeg/games/games61-70.htm).] In the first round, lemons dominated and few good cars were sold. Buyers who got the lemons lost thousands of dollars, while the sellers walked away with phenomel profits. Had we kept repeating the simulation under these rules, the good cars would have evaporated completely and the market would have been dominated by lemons.
